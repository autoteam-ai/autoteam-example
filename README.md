...
一个零依赖的 Node 订单命令行工具，用来演示 [ai-workflow](https://github.com/songhuangcn/ai-workflow)：这个仓库的功能由 Planner / Implementer / Reviewer / Auditor 四个 agent 开发，人只负责提需求和批准任务。
...
```bash
gh release download --repo songhuangcn/ai-workflow-example --pattern 'orders-*.tgz' --dir /tmp/orders-release
